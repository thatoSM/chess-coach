...
## Game 31 — WIN · Black vs samerhatam (947) · White resigned

- Colour: I played Black. Eval direction: NEGATIVE evals are my advantage.
- Link: https://lichess.org/BUqKSmpi
- PGN: `games/pgn/game-31-samerhatam.pgn`
...
## Game 30 — WIN · White vs MarcoxNew (1009) · Black resigned

- Colour: I played White. Eval direction: positive evals are my advantage.
- Link: https://lichess.org/G9ZL0pV1
- PGN: `games/pgn/game-30-marcoxnew.pgn`
- Result: Black resigned.
- **Me: [NOT YET ANALYSED] accuracy · blunders · mistakes · inaccuracies · ACPL.**
- **Opponent: [NOT YET ANALYSED]**
...
## Game 29 — LOSS · Black vs yahto19 (1061) · 31.Qxh7# (checkmate)

- Colour: I played Black. Eval direction: NEGATIVE evals are my advantage.
- Link: https://lichess.org/6DCNXsRu
- PGN: `games/pgn/game-29-yahto19.pgn`
...
## Game 28 — LOSS · White vs spoof-em-up (971) · White resigned

- Colour: I played White. Eval direction: positive evals are my advantage.
- Link: https://lichess.org/cgYF8YgR
- PGN: `games/pgn/game-28-spoof-em-up.pgn`
- Result: White resigned.
- **Me: [NOT YET ANALYSED] accuracy · blunders · mistakes · inaccuracies · ACPL.**
- **Opponent: [NOT YET ANALYSED]**
...
## Game 27 — WIN · Black vs PTSD_chess (893) · White lost on time

- Colour: I played Black. Eval direction: NEGATIVE evals are my advantage.
- Link: https://lichess.org/ztyU5exA
- PGN: `games/pgn/game-27-ptsd-chess.pgn`
...
## Game 26 — LOSS · Black vs kai-reader (961) · 15.Qg7# (checkmate)

- Colour: I played Black. Eval direction: NEGATIVE evals are my advantage.
- Link: https://lichess.org/gGP3SzuK
- PGN: `games/pgn/game-26-kai-reader.pgn`
- Result: White won by checkmate.
- **Me: [NOT YET ANALYSED] accuracy · blunders · mistakes · inaccuracies · ACPL.**
- **Opponent: [NOT YET ANALYSED]**
...
## Game 25 — LOSS · White vs minikmustafa (998) · 92...Qb6# (checkmate)

- Colour: I played White. Eval direction: positive evals are my advantage.
- Link: https://lichess.org/J8xB213W
- PGN: `games/pgn/game-25-minikmustafa.pgn`
- Result: Black won by checkmate.
- **Me: [NOT YET ANALYSED] accuracy · blunders · mistakes · inaccuracies · ACPL.**
- **Opponent: [NOT YET ANALYSED]**
...
## Game 24 — WIN · Black vs mixiaoquan (949) · 76...Qc1# (checkmate)

- Colour: I played Black. Eval direction: NEGATIVE evals are my advantage.
- Link: https://lichess.org/mWdR1i2R
- PGN: `games/pgn/game-24-mixiaoquan.pgn`
- Result: Black won by checkmate.
- **Me: [NOT YET ANALYSED] accuracy · blunders · mistakes · inaccuracies · ACPL.**
- **Opponent: [NOT YET ANALYSED]**
...
## Game 23 — WIN · White vs judy08 (919) · Black resigned

- Colour: I played White. Eval direction: positive evals are my advantage.
- Link: https://lichess.org/p4N9lzno
- PGN: `games/pgn/game-23-judy08.pgn`
- Result: Black resigned.
- **Me: [NOT YET ANALYSED] accuracy · blunders · mistakes · inaccuracies · ACPL.**
- **Opponent: [NOT YET ANALYSED]**
...
## Game 22 — WIN · White vs Kavikg (950) · Black resigned

- Colour: I played White. Eval direction: positive evals are my advantage.
- Link: https://lichess.org/mbHl3Ybl
- PGN: `games/pgn/game-22-kavikg.pgn`
- Result: Black resigned.
- **Me: [NOT YET ANALYSED] accuracy · blunders · mistakes · inaccuracies · ACPL.**
- **Opponent: [NOT YET ANALYSED]**
...
## Game 21 — LOSS · White vs GiftmischerPTA (973) · 63...Qgg5# (checkmate)

- Colour: I played White. Eval direction: positive evals are my advantage.
- Link: https://lichess.org/AfDFvPd9
- PGN: `games/pgn/game-21-giftmischerpta.pgn`
- Result: Black won by checkmate.
- **Me: [NOT YET ANALYSED] accuracy · blunders · mistakes · inaccuracies · ACPL.**
- **Opponent: [NOT YET ANALYSED]**
...
## Game 20 — WIN · Black vs s-arsentev (1028) · White resigned

- Colour: I played Black. Eval direction: NEGATIVE evals are my advantage.
- Link: https://lichess.org/5MSpOtqa
- PGN: `games/pgn/game-20-s-arsentev.pgn`
- Result: White resigned.
- **Me: [NOT YET ANALYSED] accuracy · blunders · mistakes · inaccuracies · ACPL.**
- **Opponent: [NOT YET ANALYSED]**
...
## Game 19 — WIN · Black vs djwhy (962) · 20...Qxh2# (checkmate)

- Colour: I played Black. Eval direction: NEGATIVE evals are my advantage.
- Link: https://lichess.org/STOlKAin
- PGN: `games/pgn/game-19-djwhy.pgn`
- Result: Black won by checkmate.
- **Me: [NOT YET ANALYSED] accuracy · blunders · mistakes · inaccuracies · ACPL.**
- **Opponent: [NOT YET ANALYSED]**
...
## Game 18 — LOSS · Black vs rudecula (942) · Black resigned

- Colour: I played Black. Eval direction: NEGATIVE evals are my advantage.
- Link: https://lichess.org/X4ZzlBaT
- PGN: `games/pgn/game-18-rudecula.pgn`
- Result: Black resigned.
- **Me: [NOT YET ANALYSED] accuracy · blunders · mistakes · inaccuracies · ACPL.**
- **Opponent: [NOT YET ANALYSED]**
...
## Game 17 — WIN · White vs jamaa2016 (1064) · 34.Rdg7# (checkmate)

- Colour: I played White. Eval direction: positive evals are my advantage.
- Link: https://lichess.org/j9fTnhKM
- PGN: `games/pgn/game-17-jamaa2016.pgn`
- Result: White won by checkmate.
- **Me: [NOT YET ANALYSED] accuracy · blunders · mistakes · inaccuracies · ACPL.**
- **Opponent: [NOT YET ANALYSED]**
...
## Game 16 — WIN · Black vs kangbin (978) · 29...Qf2# (checkmate)

- Colour: I played Black. Eval direction: NEGATIVE evals are my advantage.
- Link: https://lichess.org/bdIYzZni
- PGN: `games/pgn/game-16-kangbin.pgn`
- Result: Black won by checkmate.
- **Me: [NOT YET ANALYSED] accuracy · blunders · mistakes · inaccuracies · ACPL.**
- **Opponent: [NOT YET ANALYSED]**
...
## Game 15 — LOSS · White vs MaksimFFF15 (904) · White resigned

- Colour: I played White. Eval direction: positive evals are my advantage.
- Link: https://lichess.org/DTeaUUTI
- PGN: `games/pgn/game-15-maksimfff15.pgn`
- Result: White resigned.
- **Me: [NOT YET ANALYSED] accuracy · blunders · mistakes · inaccuracies · ACPL.**
- **Opponent: [NOT YET ANALYSED]**
...
## Game 14 — WIN · White vs mira-school (881) · Black lost on time

- Colour: I played White. Eval direction: positive evals are my advantage.
- Link: https://lichess.org/U4JeXOYB
- PGN: `games/pgn/game-14-mira-school.pgn`
...
## Game 13 — LOSS · Black vs Nicole27Zaeem (968) · 43.Re8# (checkmate)

- Colour: I played Black. Eval direction: NEGATIVE evals are my advantage.
- Link: https://lichess.org/uzWiebbi
- PGN: `games/pgn/game-13-nicole27zaeem.pgn`
- Result: White won by checkmate.
- **Me: [NOT YET ANALYSED] accuracy · blunders · mistakes · inaccuracies · ACPL.**
- **Opponent: [NOT YET ANALYSED]**
...
## Game 12 — LOSS · White vs Danincontro (871) · 22...Qg2# (checkmate)

- Colour: I played White. Eval direction: positive evals are my advantage.
- Link: https://lichess.org/V49fceDL
- PGN: `games/pgn/game-12-danincontro.pgn`
- Result: Black won by checkmate.
- **Me: [NOT YET ANALYSED] accuracy · blunders · mistakes · inaccuracies · ACPL.**
- **Opponent: [NOT YET ANALYSED]**
...
## Game 11 — LOSS · Black vs Movva_Bhavishy_Ram (923) · 14.Qxh7# (checkmate)

- Colour: I played Black. Eval direction: NEGATIVE evals are my advantage.
- Link: https://lichess.org/ogFPsbqX
- PGN: `games/pgn/game-11-movva-bhavishy-ram.pgn`
- Result: White won by checkmate.
- **Me: [NOT YET ANALYSED] accuracy · blunders · mistakes · inaccuracies · ACPL.**
- **Opponent: [NOT YET ANALYSED]**
