...
## Game 40 — WIN · Black (982) vs MGPier (990) · White resigned

- Colour: I played Black. Eval direction: NEGATIVE evals are my advantage.
- Link: https://lichess.org/Vs0lX44D
- PGN: `games/pgn/game-40-mgpier.pgn`
- Moves:
  ```
  1. b3 e5 2. Nc3 Nc6 3. e4 Nf6 4. Bb2 Bc5 5. Nf3 d6 6. Na4 O-O 7. Nxc5 dxc5 8. Nxe5 Nxe5 9. Bxe5 Nxe4 10. Qe2 Nf6 11. d3 Re8 12. f4 Kf8 13. O-O-O Bg4 14. Qe3 Bxd1 15. Qxc5+ Re7 16. Kxd1 Nd7 17. Bxc7 Nxc5 18. Bxd8 Rxd8 19. Be2 Ne6 20. Rf1 Rd4 21. f5 Ng5 22. c3 Rd6 23. d4 Ne4 24. Bf3 Nxc3+ 25. Kc2 Nxa2 26. Kb2 Nb4 27. Bxb7 Rxb7 0-1
  ```
- Result: White resigned.
- **Me: 1 blunders · 0 mistakes · 2 inaccuracies · 26 ACPL.** (accuracy % isn't exposed by Lichess's API — read it off the Link above)
- **Opponent: 2 blunders · 2 mistakes · 2 inaccuracies · 57 ACPL.**
...
|---|---|---|---|---|---|
| 2 | Opponent (White) | `Nc3` | +0.00 → -0.67 | Inaccuracy | `Bb2` |
| 6 | Me (Black) | `O-O` | -0.60 → +0.24 | Inaccuracy | `Nxe4` |
| 8 | Opponent (White) | `Nxe5` | +0.33 → -0.74 | Inaccuracy | `d3` |
| 10 | Me (Black) | `Nf6` | -0.90 → +0.00 | Inaccuracy | `Nd6` |
| 11 | Opponent (White) | `d3` | +0.00 → -2.86 | Blunder | `O-O-O` |
| 12 | Opponent (White) | `f4` | -2.81 → -4.70 | Mistake | `O-O-O` |
| 12 | Me (Black) | `Kf8` | -4.70 → -1.84 | Blunder | `Nd5` |
| 14 | Opponent (White) | `Qe3` | -1.49 → -3.11 | Mistake | `Bxf6` |
| 17 | Opponent (White) | `Bxc7` | -2.84 → -6.15 | Blunder | `Qxc7` |
...
## Game 39 — WIN · Black (1000) vs khardikov (1004) · White resigned

- Colour: I played Black. Eval direction: NEGATIVE evals are my advantage.
- Link: https://lichess.org/1q3kqzCh
- PGN: `games/pgn/game-39-khardikov.pgn`
- Moves:
  ```
...
## Game 38 — DRAW · White (982) vs BiswajitShuvo (959) · draw by stalemate
...
## Game 37 — LOSS · Black (988) vs pavanraaj (978) · Black resigned
...
## Game 36 — WIN · White (985) vs abdel05 (827) · 28.Qg8# (checkmate)
...
## Game 35 — WIN · Black (979) vs Artemii_Burlakov (998) · White resigned
...
## Game 34 — LOSS · White (984) vs doctorexcal (1011) · 36...Rc1# (checkmate)
...
## Game 33 — DRAW · White (982) vs abeer_elewy (1093) · draw by stalemate
...
## Game 32 — WIN · Black (976) vs ChinJay (991) · 28...Qxe1# (checkmate)
...
## Game 31 — WIN · Black (971) vs aor_aladin (945) · White resigned
...
## Game 30 — LOSS · White (978) vs AnayAnand2016 (917) · 14...Qxh2# (checkmate)
...
## Game 29 — WIN · Black (970) vs anforce (1075) · 65...Qd2# (checkmate)
...
## Game 28 — WIN · White (964) vs BjkGoktug09 (1006) · 36.Qf2# (checkmate)
...
## Game 27 — WIN · Black (957) vs mrgrtsh (973) · White resigned
...
## Game 26 — LOSS · Black (964) vs Aaryav555 (902) · Black resigned
...
## Game 25 — LOSS · White (971) vs Aliyetkin (855) · 26...Qh1# (checkmate)
...
## Game 24 — LOSS · White (977) vs mlbbhunter (987) · 16...Qb2# (checkmate)
...
## Game 23 — LOSS · White (970) vs spoof-em-up (971) · White resigned
...
## Game 22 — WIN · Black (966) vs PTSD_chess (893) · on time
...
## Game 21 — LOSS · Black (971) vs kai-reader (961) · 15.Qg7# (checkmate)
...
## Game 20 — LOSS · White (977) vs minikmustafa (998) · 92...Qb6# (checkmate)
...
## Game 19 — WIN · Black (971) vs mixiaoquan (949) · 76...Qc1# (checkmate)
...
## Game 18 — WIN · White (967) vs judy08 (919) · Black resigned
...
## Game 17 — WIN · White (961) vs Kavikg (950) · Black resigned
...
## Game 16 — LOSS · White (967) vs GiftmischerPTA (973) · 63...Qgg5# (checkmate)
...
## Game 15 — LOSS · Black (981) vs rafffaelll2022 (1024) · Black resigned
...
## Game 14 — LOSS · White (987) vs rafffaelll2022 (1018) · 13...Bh6# (checkmate)
...
## Game 13 — WIN · Black (981) vs samerhatam (947) · White resigned
...
## Game 12 — WIN · White (975) vs MarcoxNew (1009) · Black resigned
...
## Game 11 — LOSS · Black (980) vs yahto19 (1061) · 31.Qxh7# (checkmate)
...
## Game 9 — WIN · White (965) vs water-dragon562 (1112) · Black resigned
