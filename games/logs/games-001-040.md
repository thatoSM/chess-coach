...
|---|---|---|---|---|---|
| 6 | Me | `d6` | -0.20 → +1.07 | Mistake | `h6` |
| 8 | Me | `b5` | +0.73 → +2.32 | Mistake | `Be6` |
| 9 | Opponent | `Bxf6` | +2.32 → +0.57 | Mistake | `Qd2` |
| 11 | Me | `Be6` | +0.59 → +1.23 | Inaccuracy | `Nxb3` |
| 12 | Opponent | `Qd2` | +1.23 → +0.21 | Inaccuracy | `Nxd4` |
| 13 | Me | `c6` | +0.11 → +4.34 | Blunder | `Kh8` |
| 14 | Opponent | `Nc3` | +4.34 → -0.69 | Blunder | `Qh6` |
| 14 | Me | `Bxb3` | -0.69 → +0.33 | Inaccuracy | `Bh3` |
| 15 | Me | `d5` | +0.21 → +1.32 | Inaccuracy | `f5` |
| 16 | Opponent | `exd5` | +1.32 → +0.69 | Inaccuracy | `Kh1` |
| 17 | Opponent | `f4` | +1.23 → -0.40 | Mistake | `Kh1` |
| 17 | Me | `d4` | -0.40 → +0.42 | Inaccuracy | `Kh8` |
| 18 | Me | `Qc8` | +0.45 → +2.13 | Mistake | `Be7` |
| 19 | Opponent | `fxe5` | +2.13 → +0.59 | Mistake | `Nxf6+` |
| 19 | Me | `fxe5` | +0.59 → +8.49 | Blunder | `Qg4+` |
| 21 | Opponent | `Qxe5+` | +7.73 → +5.24 | Inaccuracy | `Qf6+` |
| 21 | Me | `Kg8` | +5.24 → +7.79 | Inaccuracy | `f6` |
| 23 | Me | `Rae8` | +5.04 → +7.28 | Inaccuracy | `Qf3+` |
| 26 | Opponent | `Qb6` | +6.04 → -3.94 | Blunder | `Qf6` |
| 27 | Me | `Qd5` | -2.74 → +5.68 | Blunder | `Rc6` |
| 28 | Opponent | `Qg6+` | +5.68 → -7.47 | Blunder | `Ne4` |
| 30 | Opponent | `b4` | -10.48 → #-8 | Inaccuracy | `c3` |
