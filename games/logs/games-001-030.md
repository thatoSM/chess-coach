# Games 1–30 — full entries

Detail file. The scannable index of every game lives in `games/game-log.md`.
Aggregate pattern evidence lives in `docs/03-my-recurring-mistakes.md` — that
file is never split.
